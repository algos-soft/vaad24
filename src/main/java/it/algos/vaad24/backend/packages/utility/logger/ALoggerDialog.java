...
public class ALoggerDialog extends CrudDialog {
     ...
     */
    public ALoggerDialog(final ALogger entityBean, final CrudOperation operation, final CrudBackend crudBackend, final List fields) {
