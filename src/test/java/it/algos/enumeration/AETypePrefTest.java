...
public class AETypePrefTest extends AlgosUnitTest {
    ...
    private AETypePref[] matrice;

    private List<AETypePref> listaEnum;
    ...
    void forEach() {
        listaEnum = AETypePref.getAllEnums();
    ...
    void allTag() {
        listaTag = AETypePref.getAllTags();
