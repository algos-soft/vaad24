...
public class AEFontStyleTest extends AlgosTest {
    ...
    private AEFontStyle[] matrice;

    private List<AEFontStyle> listaEnum;
    ...
    void matrice() {
        ...
        System.out.println(VUOTA);
        for (AEFontStyle valore : matrice) {
    ...
    void forEach() {
        listaEnum = AEFontStyle.getAllEnums();
    ...
    void allTag() {
        listaTag = AEFontStyle.getAllTags();
