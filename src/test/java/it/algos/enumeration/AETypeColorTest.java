...
@Tag("quickly")
@Tag("enums")
@DisplayName("Enumeration AETypeColor")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class AETypeColorTest extends AlgosTest {


    private AETypeColor type;

    private AETypeColor[] matrice;

    private List<AETypeColor> listaEnum;
    ...
    void matrice() {
        ...
        System.out.println(VUOTA);
        for (AETypeColor valore : matrice) {
    ...
    void forEach() {
        listaEnum = AETypeColor.getAllEnums();
    ...
    void allTag() {
        listaTag = AETypeColor.getAllTags();
