...
@Tag("quickly")
@Tag("enums")
@DisplayName("Enumeration AEContinente")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class AEContinenteTest extends AlgosTest {


    private AEContinente type;

    private AEContinente[] matrice;

    private List<AEContinente> listaEnum;
    ...
    void matrice() {
        ...
        System.out.println(VUOTA);
        for (AEContinente valore : matrice) {
    ...
    void forEach() {
        listaEnum = AEContinente.getAllEnums();
    ...
    void allTag() {
        listaTag = AEContinente.getAllTags();
