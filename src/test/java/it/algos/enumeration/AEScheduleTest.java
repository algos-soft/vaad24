...
public class AEScheduleTest extends AlgosTest {
    ...
    private AESchedule[] matrice;

    private List<AESchedule> listaEnum;
    ...
    void forEach() {
        listaEnum = AESchedule.getAllEnums();
    ...
    @Test
    @Order(4)
    @DisplayName("4 - pattern di ogni singola enumeration")
    void tag() {
        listaEnum = AESchedule.getAllEnums();
        assertNotNull(listaEnum);

        System.out.println("Tutti i pattern di ogni singola enumeration");
        System.out.println(VUOTA);
        System.out.println(String.format("Ci sono %d elementi nella Enumeration, recuperati in %s", listaEnum.size(), dateService.deltaTextEsatto(inizio)));
        System.out.println(VUOTA);
        listaEnum.forEach(e -> {
    ...
    @Test
    @Order(5)
    @DisplayName("5 - lista dei pattern")
    void allTag() {
        listaTag = AESchedule.getAllPattern();
        assertNotNull(listaTag);

        System.out.println("Tutti i valori 'pattern' della enumeration");
        System.out.println(VUOTA);
    ...
    @Test
    @Order(6)
    @DisplayName("6 - pattern e nota")
    void descrizione() {
        listaEnum = AESchedule.getAllEnums();
        assertNotNull(listaEnum);

        System.out.println("pattern e nota di ogni singola enumeration");
        System.out.println(VUOTA);
        System.out.println(String.format("Ci sono %d elementi nella Enumeration, recuperati in %s", listaEnum.size(), dateService.deltaTextEsatto(inizio)));
        System.out.println(VUOTA);
        listaEnum.forEach(e -> {
